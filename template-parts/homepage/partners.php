...
?>
<section class="partners-section container-fluid pb-lg-8 pb-md-6 pt-0">
    <div class="container">

        <!-- Section Header -->
        <?php if ($main_title) : ?>
            <div class="partners-header mb-lg-8 mb-md-6">
                ...
                <div class="partner-item">
                    <?php if ($link_url) : ?>
                        <a
                            ...
                            <!-- FIX: Koristi konkretne dimenzije (100px max-height desktop) -->
                            <img
                    ...
                    <?php else : ?>
                        <div class="partner-link">
                            <!-- FIX: Koristi konkretne dimenzije -->
                            <img
                                src="<?php echo esc_url($logo_url); ?>"
                                alt="<?php echo esc_attr($logo_alt); ?>"
                                class="partner-logo"
